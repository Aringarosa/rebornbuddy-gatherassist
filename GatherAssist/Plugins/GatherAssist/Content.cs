...
namespace GatherAssist
{
    ...
    public static class Content
    {
        ...
        public static DataTable CreateItemsTable()
        {
            ...
            ////itemsTable.Rows.Add("Brown Pigment", "Miner", 10, "Rocky Outcrop", 60, "232.073792, 73.82699, -289.451752", GatherAssist.NOSLOT); // flagged
            ////itemsTable.Rows.Add("Button Mushroom", "Botanist", 18, "Lush Vegetation Patch", 80, "-344.0994, -28.06476, -41.86419", GatherAssist.NOSLOT); // flagged
            ...
            ////itemsTable.Rows.Add("Raw Malachite", "Miner", 18, "Mineral Deposit", 95, "-183.1978, -34.69329, -37.8227", GatherAssist.NOSLOT);
            ...
            ////itemsTable.Rows.Add("Wind Rock", "Miner", 5, "Rocky Outcrop", 95, "45.63465, 6.407045, 8.635086", GatherAssist.NOSLOT);
            ...
            itemsTable.Rows.Add("Black Alumen", "Miner", 5, "Mineral Deposit", 40, 60, "364.1767, -4.775018, 69.99052", 1);
