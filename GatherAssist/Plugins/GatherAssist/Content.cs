...
namespace GatherAssist
{
    ...
    public static class Content
    {
        ...
        public static DataTable CreateItemsTable()
        {
            ...
            itemsTable.Rows.Add("Block of Snow", "There Are No Good Answers", "Miner", 23, "Mineral Deposit", 37, 80, "141.7172, 280.5005, 19.43826", 6);
            itemsTable.Rows.Add("Superior Repair Stone", "Rocks of Brains", "Miner", 23, "Mineral Deposit", 40, 80, "77.62911, 217.6815, 420.8323", 6);
            itemsTable.Rows.Add("Repair Stone", "Rocks of Brains", "Miner", 23, "Mineral Deposit", 37, 80, "77.62911, 217.6815, 420.8323", 3);
            itemsTable.Rows.Add("Blue Mythril Ore", "Mythril Madness", "Miner", 23, "Mineral Deposit", 37, 80, "446.4557, 232.4317, 323.9256", 2);
            itemsTable.Rows.Add("Rich Blue Mythril Ore", "Mythril Madness", "Miner", 23, "Mineral Deposit", 40, 80, "446.4557, 232.4317, 323.9256", 5);
            // 40-45
            itemsTable.Rows.Add("Marcasite", "Brother in Arms", "Miner", 23, "Mineral Deposit", 42, 80, "-723.2169, 226.3917, -6.858791", 5);
            itemsTable.Rows.Add("Building Stone", "Breach and Build", "Miner", 23, "Mineral Deposit", 42, 80, "-780.027, 241.8041, -162.4704", 3);
            itemsTable.Rows.Add("Tundra", "Not Losing our Heads This Time", "Miner", 23, "Mineral Deposit", 42, 110, "-570.0806, 204.243, -343.9917", 3);
            itemsTable.Rows.Add("Permafrost", "Not Losing our Heads This Time", "Miner", 23, "Mineral Deposit", 45, 110, "-570.0806, 204.243, -343.9917", 5);
            itemsTable.Rows.Add("Snowcloak Slab", "Nature is a Monster", "Miner", 23, "Mineral Deposit", 42, 80, "-760.9202, 223.4206, 36.56805", 1);
            itemsTable.Rows.Add("Clear Snowcloak Slab", "Nature is a Monster", "Miner", 23, "Mineral Deposit", 45, 80, "-760.9202, 223.4206, 36.56805", 3);
            //45-50
            itemsTable.Rows.Add("Crystallized Root", "Hybrid Hypotheses", "Miner", 24, "Mineral Deposit", 47, 120, "431.791, -15.65618, -369.2624", 7);
            itemsTable.Rows.Add("Crystallized Trunk", "Hybrid Hypotheses", "Miner", 24, "Mineral Deposit", 50, 120, "431.791, -15.65618, -369.2624", 5);
            ...
            itemsTable.Rows.Add("Black Alumen", "", "Miner", 5, "Mineral Deposit", 40, 80, "364.1767, -4.775018, 69.99052", 1);
            ...
            itemsTable.Rows.Add("Brimstone", "", "Miner", 15, "Rocky Outcrop", 30, 80, "-450.4195, -5.269686, 253.1701", 7); // no aetheryte
            ...
            itemsTable.Rows.Add("Chamomile", "", "Botanist", 15, "Lush Vegetation Patch", 25, 80, "-364.8127, -1.948596, 152.6039", 5); // no aetheryte
            itemsTable.Rows.Add("Chanterelle", "", "Botanist", 3, "Lush Vegetation Patch", 15, 80, "62.98865, -8.831064, 122.1805", 6);
            itemsTable.Rows.Add("Chocobo Feather", "", "Botanist", 5, "Mature Tree", 30, 80, "224.0834, 17.33236, -122.0438", 0);
            itemsTable.Rows.Add("Cieldalaes Spinach", "", "Botanist", 10, "Lush Vegetation Patch", 15, 80, "266.3692, 45.04897, 34.22172", 5);
            ...
            itemsTable.Rows.Add("Earth Crystal", "", "Miner", 10, "Rocky Outcrop", 30, 60, "232.073792, 73.82699, -289.451752", GatherAssist.NOSLOT); // fix object level
            ...
            itemsTable.Rows.Add("Fire Crystal", "", "Miner", 18, "Rocky Outcrop", 30, 95, "140.7642, 7.528731, -98.47753", GatherAssist.NOSLOT);
            itemsTable.Rows.Add("Fine Sand", "", "Miner", 53, "Rocky Outcrop", 15, 80, "-356.4178, 0.6453676, 69.35533", 2);
            itemsTable.Rows.Add("Fire Rock", "", "Miner", 15, "Rocky Outcrop", 25, 80, "-426.8347, -1.837528, 116.2488", 3); // no aetheryte
            ...
            itemsTable.Rows.Add("Fire Shard", "", "Botanist", 52, "Mature Tree", 30, 80, "-230.5813, 14.96386, -368.5225", 4);
            itemsTable.Rows.Add("Fire Shard", "", "Miner", 17, "Mineral Deposit", 5, 80, "264.2455, 56.165, 216.7509", 4);
            ...
            itemsTable.Rows.Add("Grade 2 Carbonized Matter", "", "Botanist", 3, "Mature Tree", 30, 80, "158.9255, -24.59291, 471.9808", 0);
            itemsTable.Rows.Add("Grade 2 Carbonized Matter", "", "Botanist", 5, "Mature Tree", 30, 80, "-209.3807, 8.241471, 14.18696", 0);
            itemsTable.Rows.Add("Grade 2 Carbonized Matter", "", "Botanist", 52, "Mature Tree", 30, 80, "-230.5813, 14.96386, -368.5225", 0);
            itemsTable.Rows.Add("Grade 2 Carbonized Matter", "", "Botanist", 53, "Mature Tree", 30, 80, "159.5731, 10.81703, 453.5827", 0);
            itemsTable.Rows.Add("Grade 2 Carbonized Matter", "", "Botanist", 7, "Mature Tree", 30, 80, "252.646, -9.157417, 13.05055", 0);
            itemsTable.Rows.Add("Grade 2 Carbonized Matter", "", "Miner", 10, "Rocky Outcrop", 30, 80, "267.9286, 74.66428, -302.3478", 0);
            ...
            itemsTable.Rows.Add("Grade 2 Carbonized Matter", "", "Miner", 4, "Rocky Outcrop", 30, 80, "-62.15393, -10.53283, 288.2905", 0);
            itemsTable.Rows.Add("Grade 3 Carbonized Matter", "", "Miner", 10, "Rocky Outcrop", 50, 80, "-7.995946, 41.8293, 684.2917", 0);
            itemsTable.Rows.Add("Grade 3 Carbonized Matter", "", "Miner", 13, "Rocky Outcrop", 50, 80, "711.1254, 28.62663, 409.9852", 0);
            itemsTable.Rows.Add("Grade 3 Carbonized Matter", "", "Miner", 17, "Rocky Outcrop", 50, 80, "-167.8359, 38.24171, 363.1013", 0);
            itemsTable.Rows.Add("Grade 3 Carbonized Matter", "", "Miner", 4, "Rocky Outcrop", 50, 80, "-162.7803, -1.348187, 168.7855", 0);
            ...
            itemsTable.Rows.Add("Ice Shard", "", "Botanist", 3, "Mature Tree", 5, 60, "61.01541, 4.252214, -174.6979", 4);
            ...
            itemsTable.Rows.Add("La Noscean Lettuce", "", "Botanist", 52, "Lush Vegetation Patch", 15, 80, "51.5785, 52.90682, -112.3378", 5);
            ...
            itemsTable.Rows.Add("Lightning Crystal", "", "Miner", 19, "Rocky Outcrop", 30, 80, "-122.5412, 21.88736, -489.5768", GatherAssist.NOSLOT);
            itemsTable.Rows.Add("Lightning Rock", "", "Miner", 15, "Rocky Outcrop", 25, 80, "-426.8347, -1.837528, 116.2488", 6); // no aetheryte
            ...
            itemsTable.Rows.Add("Lowland Grapes", "", "Botanist", 10, "Lush Vegetation Patch", 15, 80, "266.3692, 45.04897, 34.22172", 2);
            ...
            itemsTable.Rows.Add("Mirror Apple", "", "Botanist", 23, "Mature Tree", 45, 90, "71.41046, 287.098, -177.7301", 1);
            itemsTable.Rows.Add("Mistletoe", "", "Botanist", 23, "Mature Tree", 45, 90, "71.41046, 287.098, -177.7301", 7);
            ...
            itemsTable.Rows.Add("Pixie Plums", "", "Botanist", 15, "Lush Vegetation Patch", 25, 80, "-364.8127, -1.948596, 152.6039", 2); // no aetheryte
            ...
            itemsTable.Rows.Add("Purple Pigment", "", "Miner", 19, "Rocky Outcrop", 30, 80, "-123.4877, 19.20007, -520.1481", 5);
            ...
            itemsTable.Rows.Add("Rosewood Log", "", "Botanist", 4, "Mature Tree", 50, 90, "-252.335, 6.061327, 85.4445", 5);
            itemsTable.Rows.Add("Ruby Tomato", "", "Botanist", 52, "Lush Vegetation Patch", 15, 80, "51.5785, 52.90682, -112.3378", 1);
            ...
            itemsTable.Rows.Add("Salt Leek", "", "Botanist", 11, "Lush Vegetation Patch", 35, 80, "259.4367, 40.34094, 430.9537", 6);
            ...
            itemsTable.Rows.Add("Siltstone", "", "Miner", 15, "Rocky Outcrop", 30, 80, "-450.4195, -5.269686, 253.1701", 2); // no aetheryte
            ...
            itemsTable.Rows.Add("Soiled Femur", "", "Miner", 17, "Mineral Deposit", 10, 70, "42.55082, 57.27194, 353.5192", 3);
            itemsTable.Rows.Add("Soiled Femur", "", "Miner", 53, "Mineral Deposit", 10, 60, "-66.32383, -4.023734, 45.27408", 3);
            itemsTable.Rows.Add("Sticky Rice", "", "Botanist", 15, "Lush Vegetation Patch", 25, 80, "-364.8127, -1.948596, 152.6039", 3); // no aetheryte
            ...
            itemsTable.Rows.Add("Sunrise Tellin", "", "Miner", 14, "Mineral Deposit", 20, 80, "353.6206, 2.336102, 74.7085", 0);
            ...
            itemsTable.Rows.Add("Tin Ore", "", "Miner", 53, "Mineral Deposit", 10, 60, "-66.32383, -4.023734, 45.27408", 1);
            ...
            itemsTable.Rows.Add("Walnut Log", "", "Botanist", 5, "Mature Tree", 25, 90, "54.04222, 6.036263, 7.647984", 5);
            itemsTable.Rows.Add("Water Crystal", "", "Miner", 17, "Rocky Outcrop", 30, 80, "105.9706, 19.30649, 85.6742", GatherAssist.NOSLOT);
            itemsTable.Rows.Add("Water Rock", "", "Miner", 15, "Rocky Outcrop", 25, 80, "-426.8347, -1.837528, 116.2488", 5); // no aetheryte
            ...
            itemsTable.Rows.Add("Wind Crystal", "", "Botanist", 3, "Mature Tree", 30, 80, "158.9255, -24.59291, 471.9808", 6); // rethink crystals, the positions move.
            itemsTable.Rows.Add("Wind Crystal", "", "Miner", 4, "Rocky Outcrop", 50, 80, "-162.7803, -1.348187, 168.7855", 5); // rethink crystals, the positions move.
            itemsTable.Rows.Add("Wind Rock", "", "Miner", 5, "Rocky Outcrop", 25, 90, "55.40574, 5.669168, 12.8003", 6);
            ...
            itemsTable.Rows.Add("Yew Branch", "", "Botanist", 4, "Mature Tree", 20, 90, "-325.5423, -0.854171, 275.6144", 2);
            itemsTable.Rows.Add("Yew Log", "", "Botanist", 4, "Mature Tree", 20, 90, "-325.5423, -0.854171, 275.6144", 5);
            itemsTable.Rows.Add("Zinc Ore", "", "Miner", 17, "Mineral Deposit", 10, 70, "42.55082, 57.27194, 353.5192", 2);
            itemsTable.Rows.Add("Zinc Ore", "", "Miner", 53, "Mineral Deposit", 10, 60, "-66.32383, -4.023734, 45.27408", 2);
